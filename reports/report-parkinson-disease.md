# Drug Target Reconnaissance: Parkinson disease

**Disease ID:** ENSG00000188906
**Targets analyzed:** 5
...
| Metric | Value |
|--------|-------|
| Association Score | 0.880 |
| UniProt Accession | Q5S007 |
| Protein Class | Belongs to the protein kinase superfamily. TKL Ser/Thr protein kinase family |
| 3D Structure | Yes |
| Known Compounds | 54 |
| Max Drug Phase | 4 |
| PubMed Papers | 393 |
...
## 2. SNCA — synuclein alpha

| Metric | Value |
|--------|-------|
| Association Score | 0.872 |
| UniProt Accession | P37840 |
| Protein Class | Belongs to the synuclein family |
| 3D Structure | Yes |
| Known Compounds | 66 |
| Max Drug Phase | 4 |
| PubMed Papers | 242 |
...
## 3. ATP13A2 — ATPase cation transporting 13A2

| Metric | Value |
|--------|-------|
| Association Score | 0.857 |
| UniProt Accession | Q9NQ11 |
| Protein Class | Belongs to the cation transport ATPase (P-type) (TC 3.A.3) family. Type V subfamily |
| 3D Structure | Yes |
| Known Compounds | 0 |
| Max Drug Phase | 0 |
| PubMed Papers | 30 |
...
## 4. PRKN — parkin RBR E3 ubiquitin protein ligase

| Metric | Value |
|--------|-------|
| Association Score | 0.857 |
| UniProt Accession | O60260 |
| Protein Class | Belongs to the RBR family. Parkin subfamily |
| 3D Structure | Yes |
| Known Compounds | 0 |
| Max Drug Phase | 0 |
| PubMed Papers | 95 |
...
## 5. PINK1 — PTEN induced kinase 1

| Metric | Value |
|--------|-------|
| Association Score | 0.856 |
| UniProt Accession | Q9BXM7 |
| Protein Class | Belongs to the protein kinase superfamily. Ser/Thr protein kinase family |
| 3D Structure | Yes |
| Known Compounds | 32 |
| Max Drug Phase | 4 |
| PubMed Papers | 317 |
...
LRRK2 and PINK1 represent the most promising drug targets for Parkinson's disease, driven by their strong genetic associations, excellent druggability as kinases, and compounds in late-stage clinical development. LRRK2's established role in alpha-synuclein aggregation and ongoing specific inhibitor trials make it highly attractive despite some inconclusive literature, warranting optimization and patient stratification. For PINK1, developing selective activators to enhance its crucial role in the PINK1-PRKN mitophagy pathway is a clear and actionable next step. SNCA, despite its intrinsically disordered nature and thus challenging druggability, merits continued investigation into aggregation modulators given its central pathogenic role and existing clinical-stage compounds. Finally, PRKN, a critical mitophagy regulator, warrants exploration with emerging E3 ligase-targeting modalities like PROTACs.